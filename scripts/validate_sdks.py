...
def main():
    parser = argparse.ArgumentParser(
        description="Validate JSON SDK records against a JSON schema."
    )
    parser.add_argument(
        "--schema",
        "-s",
        default=os.path.join(os.path.dirname(__file__), "..", "okodb", "schemas", "sdk.schema.json"),
        help="Path to the JSON schema file"
    )
    parser.add_argument(
        "--records",
        "-r",
        default=os.path.join(os.path.dirname(__file__), "..", "okodb", "sdks", "*.json"),
